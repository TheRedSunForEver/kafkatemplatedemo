...
public class Demo {
    ...
    private Map<String, Object> consumerProps() {
        ...
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "192.168.113.130:9092");
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "xgroup");
    ...
    private Map<String, Object> senderProps() {
        Map<String, Object> props = new HashMap<>();
        props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "192.168.113.130:9092");
